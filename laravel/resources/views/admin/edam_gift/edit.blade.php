                ...
                <div class="admin-table-card" style="padding: 30px;">
                    <form action="{{ route('produits.update', $produit->id) }}" method="POST">
                        ...
                        <div class="form-group" style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="image" id="image" value="{{ $produit->image }}" class="admin-input" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px;" required>
                        </div>
